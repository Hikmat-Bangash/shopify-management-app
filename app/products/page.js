...
export default function DashboardPage() {
  ...
  const handleViewProduct = (productHandle) => {
            ...
            <tr key={product.id}>
              ...
              <td className="border px-4 py-2 text-center">
                <button
                  ...
                  className="bg-blue-400 hover:bg-blue-500 cursor-pointer text-white px-3 py-1 rounded text-sm transition-colors duration-200 flex items-center gap-1 mx-auto"
                >
